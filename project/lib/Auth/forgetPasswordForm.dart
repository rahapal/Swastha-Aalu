      ...
      child: Column(
        children: [
          ...
          SizedBox(
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                ...
                icon:
                    Icon(Icons.mail_outline, color: GlobalVariables.mainColor),
                enabledBorder: OutlineInputBorder(
                    borderSide:
                        BorderSide(width: 1, color: GlobalVariables.mainColor),
          ...
          OutlinedButton(
            style: ButtonStyle(
                backgroundColor:
                    MaterialStateProperty.all<Color>(GlobalVariables.mainColor),
                foregroundColor:
